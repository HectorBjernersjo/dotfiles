...
return
#c::
    c_id := HandleShortcut(c_id, "C:\Program Files\Mozilla Firefox\firefox.exe --new-window gemini.google.com", SECONDARY_MONITOR)
return
...
return
#n::
    n_id := HandleShortcut(n_id, "C:\Program Files\JetBrains\JetBrains Rider 2025.1.1\bin\rider64.exe", MAIN_MONITOR) ;, "wsl tmux")
return
...
#+m::
    WinGet, m_id, ID, A
#m::
    m_id := HandleShortcut(m_id, "C:\Program Files\Mozilla Firefox\firefox.exe --new-window https://gmail.com", MAIN_MONITOR)
...
#+o::
    WinGet, o_id, ID, A
#o::
    o_id := HandleShortcut(o_id, "C:\Program Files\Obsidian\Obsidian.exe", SECONDARY_MONITOR)

s_id := ""
#+s::
    WinGet, s_id, ID, A
#s::
    s_id := HandleShortcut(s_id, "C:\Program Files\Slack\slack.exe", SECONDARY_MONITOR)

r_id := ""
#+r::
    WinGet, r_id, ID, A
#r::
    r_id := HandleShortcut(r_id, "C:\Program Files\JetBrains\JetBrains Rider 2025.1.1\bin\rider64.exe", SECONDARY_MONITOR)
return
